...
class ObstacleAvoidanceWifibot(WifibotEnv):
    ...
    def reset(self, start_pose=None, target_pose=None):
        ...
        rs_state[1089:1092] = self.sim_obstacles[0]
        rs_state[1092:1095] = self.sim_obstacles[1]
        rs_state[1095:1098] = self.sim_obstacles[2]
    ...
    def _robot_close_to_sim_obstacle(self, rs_state):
        ...
        robot_corners = self.wifibot.get_corners_positions(rs_state[3], rs_state[4], rs_state[5])
...
class ObstacleAvoidanceWifibotSim(ObstacleAvoidanceWifibot, Simulation):
    ...
    def __init__(self, ip=None, lower_bound_port=None, upper_bound_port=None, gui=False, **kwargs):
        Simulation.__init__(self, self.cmd, ip, lower_bound_port, upper_bound_port, gui, **kwargs)
        ObstacleAvoidanceWifibot.__init__(self, rs_address=self.robot_server_ip, **kwargs)